...
\textcolor{root}{root#} \textcolor{command}{cryptsetup} luksFormat --type luks2 --label <LUKS> <\textcolor{block}{/dev/sdX2}>
> YES
> <NEW_LUKS_PASSWORD>
> <NEW_LUKS_PASSWORD (VERIFY)>
\textcolor{root}{root#} \textcolor{command}{cryptsetup} open --type luks2 <\textcolor{block}{/dev/sdX2}> <luks-root>
> <PASSWORD>
